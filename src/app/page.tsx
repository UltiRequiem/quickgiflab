		...
		<main className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 py-8">
			<div className="container mx-auto px-4 space-y-8">
				...
				<div className="text-center space-y-4">
					<h1 className="text-5xl font-bold text-gray-900">Sergif 2026</h1>
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						🥳 Record high-quality GIFs with your webcam and share them with
						your friends! Completely rebuilt with modern tech for the best
						possible quality.
					</p>
				...
				<div className="max-w-2xl mx-auto p-4 bg-blue-50 border border-blue-200 rounded-lg">
					...
					<p className="text-blue-700 text-sm">
						Choose whether your GIFs are private (link-only) or public (appear
						in gallery). Private GIFs are secure by default - only people with
						the direct link can view them.
					</p>
				</div>
				...
				<footer className="text-center text-gray-500 text-sm">
					<p className="mb-2">
						🚀 Sergif 2026 - Built with Next.js 16, Bun, SQLite, T3 Env, and
						Tixte
					</p>
					<p>
						<a
